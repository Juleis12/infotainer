  ...
  <div :class="{ dark: isDarkMode }" class="min-h-screen bg-[#e8ebed] text-[#30363d] transition-colors dark:bg-[#30353a] dark:text-[#e4e8eb]">
    <nav class="sticky top-0 z-30 border-b border-[#aeb8be] bg-[#e8ebed]/95 text-[#303a42] shadow-[0_3px_0_rgba(70,84,94,0.12)] backdrop-blur dark:border-[#59636a] dark:bg-[#30353a]/95 dark:text-[#e4e8eb]">
      <div class="mx-auto flex max-w-7xl items-center gap-6 px-4 py-3 sm:px-6 lg:px-8">
        <a href="#top" class="flex items-center gap-3 text-lg font-black tracking-tight">
          <span class="grid h-9 w-9 place-items-center rounded-lg bg-[#46545e] text-sm text-white shadow-[2px_3px_0_#aeb8be]">▶</span>
          <span class="underline decoration-[#8395a2] decoration-2 underline-offset-4">Infotainer</span>
        </a>
        <div class="hidden items-center gap-6 text-sm font-semibold text-[#59656e] sm:flex dark:text-[#c7d0d5]">
          <a href="#top" class="border-b-2 border-[#607b8d] pb-1 text-[#303d46] dark:text-white">Home</a>
          <a href="#topics" class="transition hover:text-[#344853] dark:hover:text-white">Topics</a>
          <a href="#about" class="transition hover:text-[#344853] dark:hover:text-white">About</a>
        </div>
    ...
    <main id="get-started" class="mx-auto max-w-7xl px-4 pb-16 pt-0 sm:px-6 lg:px-8">
      <section class="-mt-7 relative z-10 mb-9 grid overflow-hidden rounded-sm border border-[#c6cdd1] bg-[#f4f5f5]/95 shadow-[3px_5px_0_#c8ced2] dark:border-[#5a6369] dark:bg-[#3a4044] dark:shadow-[3px_5px_0_#252a2e] sm:grid-cols-3">
        <div class="flex items-center gap-4 border-b border-[#d0d5d8] px-6 py-5 dark:border-[#555e64] sm:border-b-0 sm:border-r">
          <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg border border-[#aab5bb] bg-[#e5e9eb] text-xl text-[#46545e] dark:border-[#68737a] dark:bg-[#30363a] dark:text-[#c5d0d6]">▶</span>
          <div><strong class="block text-xl font-black">{{ channels.length }}+</strong><span class="text-xs font-semibold uppercase tracking-wide text-[#6c777e] dark:text-[#b5c0c5]">Channels</span></div>
        </div>
        <div class="flex items-center gap-4 border-b border-[#d0d5d8] px-6 py-5 dark:border-[#555e64] sm:border-b-0 sm:border-r">
          <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg border border-[#aab5bb] bg-[#e5e9eb] text-xl text-[#46545e] dark:border-[#68737a] dark:bg-[#30363a] dark:text-[#c5d0d6]">▦</span>
          <div><strong class="block text-xl font-black">{{ uniqueTagCount }}+</strong><span class="text-xs font-semibold uppercase tracking-wide text-[#6c777e] dark:text-[#b5c0c5]">Topics</span></div>
        </div>
        <div class="flex items-center gap-4 px-6 py-5">
          <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg border border-[#aab5bb] bg-[#e5e9eb] text-xl text-[#46545e] dark:border-[#68737a] dark:bg-[#30363a] dark:text-[#c5d0d6]">♧</span>
          <div><strong class="block text-xl font-black">Curious</strong><span class="text-xs font-semibold uppercase tracking-wide text-[#6c777e] dark:text-[#b5c0c5]">Minds Welcome</span></div>
        </div>
      </section>

      <section id="topics" class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p class="text-xs font-black uppercase tracking-[0.24em] text-[#657b89] dark:text-[#b9c8d1]">Curated learning</p>
    ...
    <footer id="about" class="border-t border-[#596771] bg-[#3f4b54] text-[#e9edef] dark:bg-[#272d31]">
      <div class="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <div>
          <div class="flex items-center gap-3 text-lg font-black"><span class="grid h-8 w-8 place-items-center rounded-lg bg-[#d5dadd] text-xs text-[#3f4b54]">▶</span>Infotainer</div>
          <p class="mt-2 max-w-sm text-sm text-[#c7d0d5]">A curated directory of educational YouTube channels.</p>
        </div>
        <div class="flex gap-6 text-sm font-semibold text-[#d9e0e3]"><a href="#about" class="hover:text-white">About</a><a href="#topics" class="hover:text-white">Sources</a><a href="#get-started" class="hover:text-white">Contribute</a><a href="mailto:hello@infotainer.tchh.in" class="hover:text-white">Feedback</a></div>
